...
export default function ButtonWithIconPrefix(props) {
  ...
  const variants = [
    {
      overrides: {
        ...
        ButtonWithIconPrefix: { backgroundColor: "rgba(242,242,242,1)" },
      },
      variantValues: {
        varient: "primary",
        theme: "onLightBg",
    ...
    },
    {
      overrides: {
        UI_Icons: {},
        Primary: {},
        ButtonWithIconPrefix: { backgroundColor: "rgba(75,28,125,1)" },
      },
      variantValues: {
        varient: "primary",
        theme: "onLightBg",
    ...
    {
      overrides: { UI_Icons: {}, Primary: {}, ButtonWithIconPrefix: {} },
      variantValues: {
        varient: "primary",
        theme: "onLightBg",
        state: "enabled",
